...
// Render
React.render(React.createElement(Filepicker, null), document.getElementById('content'));

},{"./src/filepicker":158,"react":157}],2:[function(require,module,exports){
...
var Filepicker = React.createClass({displayName: "Filepicker",
    ...
    render: function () {
        return (
            React.createElement("div", {className: "filepicker"})
        );
    }
