...
describe('Helpers', function()  {
  ...
  it('Correctly expands an object with an additional property', function()  {
    let expandedObject = Helpers.extend(true, {}, testObjectTwo, testObjectOne);

    expect(expandedObject.propThree).toEqual('Hi');
  });

  it('Correctly overrides an expanded property', function()  {
    let expandedObject = Helpers.extend(true, {}, testObjectTwo, testObjectOne);

    expect(expandedObject.propOne).toEqual(true);
  });

  it('Correctly expands an object with an additional property (nested)', function()  {
    let expandedObject = Helpers.extend(true, {}, testObjectTwo, testObjectOne);

    expect(expandedObject.propTwo.val).toEqual(42);
  });

  it('Correctly overrides an expanded property (nested)', function()  {
    let expandedObject = Helpers.extend(true, {}, testObjectTwo, testObjectOne);
